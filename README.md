# Selefra Provider Boundary

Use this repo as a raw reference to **tables and schema** for Terraform cloud resources. [Here's](https://github.com/selefra/selefra-provider-boundary/blob/main/docs/tables/selefra-provider-boundary.md) a summary of full coverage.
